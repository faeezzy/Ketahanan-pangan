...
# ── CLUSTER COLORS ───────────────────────────────────────────
CLUSTER_COLORS = {
    'Cluster 1 - Lumbung Padi':      '#a8e063',
    'Cluster 2 - Produksi Tinggi':   '#56ab2f',
    'Cluster 3 - Produksi Menengah': '#f0a500',
    'Cluster 4 - Produksi Rendah':   '#e05c5c',
}
...
if page == "🏠 Overview":
    ...
    n_lumbung      = len(df_cluster[df_cluster['cluster_label'].str.contains('Lumbung')])
